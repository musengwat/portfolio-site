              ...
              >
                <div className="resume__certification-header">
                  <div className="resume__certification-info">
                    ...
                    <p className="resume__certification-issuer">
                      {cert.issuer}
                    </p>
                  </div>
                  <div className="resume__certification-meta">
                    <span className="resume__certification-date">
                      {cert.date}
                    </span>
                    {cert.credential && (
                      <a
                ...
                {cert.description && (
                  <p className="resume__certification-description">
                    {cert.description}
                  </p>
                )}
              </motion.div>
        ...
        >
          ...
          <motion.div className="resume__header" variants={itemVariants}>
            ...
            <p className="resume__subtitle">
              My professional journey, education, and expertise in modern web
              development
            </p>
          </motion.div>
            ...
            <div className="resume__summary-content">
              <div className="resume__summary-text">
                <h3 className="resume__summary-title">
                  {personalInfo.title} • {personalInfo.experience} Years
                  Experience
                </h3>
                <p className="resume__summary-description">
                  Passionate full-stack developer with expertise in modern web
                  technologies. Proven track record of delivering scalable
                  applications and leading development teams. Focused on
                  creating exceptional user experiences and efficient,
                  maintainable code.
                </p>
                <div className="resume__summary-highlights">
                  <span className="resume__summary-highlight">
              ...
              {sections.map((section) => {
                ...
                return (
                  ...
                  >
                    ...
                    {section.count && (
                      <span className="resume__nav-count">{section.count}</span>
                    )}
                  </button>
                );
              })}
            ...
            <div className="resume__additional-grid">
              <div className="resume__additional-item">
                ...
                <div className="resume__additional-content">
                  ...
                  <p className="resume__additional-text">
              ...
              <div className="resume__additional-item">
                ...
                <div className="resume__additional-content">
                  ...
                  <p className="resume__additional-text">
                    {certificationsData.length} Active
                  </p>
                  <span className="resume__additional-detail">
          ...
          <motion.div className="resume__cta" variants={itemVariants}>
            <div className="resume__cta-content">
              ...
              <p className="resume__cta-description">
                Let's discuss how my skills and experience can contribute to
                your next project.
              </p>
