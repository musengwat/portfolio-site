...
export const experienceData = [
  ...
  //   type: 'Internships',
  //   description:
  //     'Gained comprehensive experience in software development and IT solutions through internships at three technology companies: Revunit, Adair Creative, and Tek Trendz. Progressed from basic web development to advanced mobile app development and IT consultancy.',
  //   achievements: [
  //     'Developed multiple web-based mobile applications using Ionic 2 framework',
  //     'Implemented Firebase integration for real-time data and authentication',
  //     'Provided technology solutions and support to 15+ small-medium businesses',
  //     'Enhanced UI/UX design skills through iterative mobile app development',
  //     'Gained hands-on experience in hardware/software deployment and troubleshooting',
  //   ],
  //   technologies: [
  //     'Ionic 2',
  //     'Firebase',
  ...
  //   ],
  //   responsibilities: [
  //     'Developed web-based mobile applications with focus on frontend development',
  //     'Implemented real-time data synchronization using Firebase',
  //     'Provided comprehensive IT support and technology consultancy',
  //     'Repaired, configured, and deployed hardware and software solutions',
  //     'Optimized applications for performance and intuitive user experience',
  //     'Collaborated with teams to deliver client-focused technology solutions',
  //   ],
  //   companyInfo: [
  //     {
  //       company: 'Revunit',
  //       period: 'January 2017 - March 2017',
  //       focus: 'Web application and mobile app development using Ionic 2',
  //       industry: 'IT Solutions',
  //       size: '25-50 employees',
  //       website: 'https://www.linkedin.com/company/revunit/',
  //     },
  //     {
  //       company: 'Adair Creative',
  //       period: 'March 2017 - May 2017',
  //       focus: 'Frontend mobile development with Firebase integration',
  //       industry: 'IT Solutions',
  //       size: '25-50 employees',
  //       website: 'https://madebyprisma.com/',
  //     },
  //     {
  //       company: 'Tek Trendz',
  //       period: 'January 2018 - May 2018',
  //       focus: 'IT solutions, support, and technology consultancy',
  //       industry: 'IT Solutions',
  //       size: '10 employees',
  //       website: 'https://tektrendz.com/',
  //     },
  //   ],
  // },
  // {
  ...
  //   endDate: '2018-05-31',
  //   type: 'Internship',
  //   description: `Provided technology solutions including comprehensive support and consultancy. Responsibilities included the repair, setup, and deployment of both hardware and software.`,
  //   responsibilities: [
  //     'Provided support to small to medium-sized businesses in Northwest Arkansas.',
  //     'Technology solutions, support, and consultancy',
  //     'Repaired, setup, and deploy hardware and software solutions',
  //   ],
  //   companyInfo: {
  //     industry: 'IT Solutions',
  //     size: '10 employees',
  ...
  //   endDate: '2017-05-31',
  //   type: 'Internship',
  //   description: `Enhanced frontend skills by developing an Ionic 2 mobile app, utilizing Firebase for real-time data and authentication, and optimizing for intuitive UI and performance.`,
  //   responsibilities: [
  //     'Developed a web-based mobile application using Ionic 2.',
  //     'Primarily focused on frontend development.',
  //     'Enhanced Firebase proficiency through application development.',
  //   ],
  //   companyInfo: {
  //     industry: 'IT Solutions',
  //     size: '25-50 employees',
  ...
  //   endDate: '2017-03-31',
  //   type: 'Internship',
  //   description: `Developed a web-based application and contributed to a mobile app using Ionic 2, with a focus on front-end development.`,
  //   responsibilities: ['Developed a web-based mobile application using Ionic 2.'],
  //   companyInfo: {
  //     industry: 'IT Solutions',
  //     size: '25-50 employees',
  //     website: 'https://www.linkedin.com/company/revunit/',
